...
public class Date implements Comparable<Date>{
	...
	public static void main(String args[]) {
		// test case 1 
		// date should be valid as it is valid day for month, and year is after 1980 and before current year
	...
	public boolean isValid() {
		...
		if(year < THE_EIGHTYS || year > Calendar.getInstance().get(Calendar.YEAR) || day > 31 || day < 1|| month > 12 || month < 1) {
			return false;
		}else{
			if(day == 31) {
